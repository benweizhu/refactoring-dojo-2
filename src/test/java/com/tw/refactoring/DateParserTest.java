...
public class DateParserTest {
    ...
    public void shouldThrowExceptionIfYearStringCannotBeParsed() {
        try {
            ...
            assertEquals(e.getMessage(), "Year string is less than 4 characters");
        }
    }
    ...
    public void shouldThrowExceptionIfYearIsNotInteger() {
        try {
            ...
            assertEquals(e.getMessage(), "Year is not an integer");
        }
    }
    ...
    public void shouldThrowExceptionIfYearIsLessThan2000() {
        try {
            ...
            assertEquals(e.getMessage(), "Year cannot be less than 2000 or more than 2012");
        }
    }
    ...
    public void shouldThrowExceptionIfMonthStringCannotBeParsed() {
        try {
            ...
            assertEquals(e.getMessage(), "Month string is less than 2 characters");
        }
    }
    ...
    public void shouldThrowExceptionIfMonthIsNotInteger() {
        try {
            ...
            assertEquals(e.getMessage(), "Month is not an integer");
        }
    }
    ...
    public void shouldThrowExceptionIfMonthIsMoreThan12() {
        try {
            ...
            assertEquals(e.getMessage(), "Month cannot be less than 1 or more than 12");
        }
    }
    ...
    public void shouldThrowExceptionIfDateStringCannotBeParsed() {
        try {
            ...
            assertEquals(e.getMessage(), "Date string is less than 2 characters");
        }
    }
    ...
    public void shouldThrowExceptionIfDateIsNotInteger() {
        try {
            ...
            assertEquals(e.getMessage(), "Date is not an integer");
        }
    }
    ...
    public void shouldThrowExceptionIfDateIsMoreThan31() {
        try {
            ...
            assertEquals(e.getMessage(), "Date cannot be less than 1 or more than 31");
        }
    }
    ...
    public void shouldThrowExceptionIfHourStringCannotBeParsed() {
        try {
            ...
            assertEquals(e.getMessage(), "Hour string is less than 2 characters");
        }
    }
    ...
    public void shouldThrowExceptionIfHourIsNotInteger() {
        try {
            ...
            assertEquals(e.getMessage(), "Hour is not an integer");
        }
    }
    ...
    public void shouldThrowExceptionIfHourIsMoreThan23() {
        try {
            ...
            assertEquals(e.getMessage(), "Hour cannot be less than 0 or more than 23");
        }
    }
    ...
    public void shouldThrowExceptionIfMinuteStringCannotBeParsed() {
        try {
            ...
            assertEquals(e.getMessage(), "Minute string is less than 2 characters");
        }
    }
    ...
    public void shouldThrowExceptionIfMinuteIsNotInteger() {
        try {
            ...
            assertEquals(e.getMessage(), "Minute is not an integer");
        }
    }
    ...
    public void shouldThrowExceptionIfMinuteIsMoreThan59() {
        try {
            ...
            assertEquals(e.getMessage(), "Minute cannot be less than 0 or more than 59");
        }
    }
